...
import { Match, type MatchSettings, type GameEvent, Player } from '../../src/domain/models'
import { GAME_EVENTS, TEAMS } from '../../src/util/constants'
...
export const makeNewPlayer = () => {
  return new Player({ inGameId: 2, nickname: 'player name', team: TEAMS.TEAM_FREE })
}
